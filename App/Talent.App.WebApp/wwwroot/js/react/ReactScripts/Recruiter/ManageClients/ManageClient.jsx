...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://1talentservicesprofile.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://1talentservicesprofile.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
